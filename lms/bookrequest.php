...
<body>
   ...
   ?>
        ...
        <div class="p"><a href="Profile.php">Profile</a></div>
        <div class="p"><a href="Books.php">Books</a></div>
        <div class="p"><a href="bookrequest.php">Book Request</a></div>
        <div class="p"><a href="requestinfo.php">Request Info</a></div>
        <div class="p"><a href="expired.php">Expired info</a></div>
    </div>
    ...
    <div id="main">
        ...
        <div class="section book-section" id="">
            <div class="main-add">
                <h2 class="addb">Request For Books</h2>
                ...
                " name="booksname" placeholder="Booksname" class="form-control" id="bname"
                            ...
                            <button type="submit" class="btn btn-primary ml-50 w-20 rounded-4 p-1">Send Request</button>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    {
      // $sql1=mysqli_query($conn,"SELECT * FROM `book_data` WHERE bookid='$_POST[bookid]';");
      // $row1=mysqli_fetch_assoc($sql1);
      // $count1=mysqli_num_rows($sql1);
      // if($count!=0)
      // {

        mysqli_query($conn,"INSERT INTO issue_book VALUES ('$_SESSION[login_user]','$_POST[bookid]','$_POST[booksname]','$_POST[author]','$_POST[edition]','$_POST[department]','','','')"); 
