...
<body>
    ...
    <div class="section stlogin-section" id="stlogin.php">
        <div class="main">
            <form name="stu_login" action="" method="post">
                <div class="modal-body mx-5">
                    ...
                    <div class="mb-3 col-md-70 ">
                        ...
                        <div id="emailHelp" class="text-primary m-2">
                            <a href="upass.php">Forgot your Password?</a>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary w-100 rounded-4 p-1">Login</button>
                    <h5 class="text">Don't have an Account?<a href="stregister.php"
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $count=0;
        $sql="SELECT * FROM stu_register WHERE uname='$_POST[uname]' && pass='$_POST[pass]'";
