...
<body>
        ...
        <form action="" method="post">
            ...
            <div class="modal-body mx-5">
                ...
                <div class="mb-4 col-md-70 ">
                    ...
                    <input type="password" class="form-control" id="password" placeholder="New Password" name="pass">
                </div>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(mysqli_query($conn, "UPDATE admin_register SET pass='$_POST[pass]', cpass='$_POST[pass]' WHERE uname='$_POST[uname]' AND email='$_POST[email]';")){
            ?>
    <script>
