...
<body>
    ...
    <div class="section stregister-section">
        <div class="main2">
            ...
            <form name="admin_register" action="" method="post">
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $count=0;
    $sqli= "SELECT `uname` from `admin_register`";
    ...
    if($count==0){
        $sql= "INSERT INTO `admin_register`(`admin_id`, `uname`, `email`, `phone`, `pass`, `cpass`,`pic`) VALUES ('NULL','$uname','$email','$phone','$pass','$cpass','p.jpg')";
